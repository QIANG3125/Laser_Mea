...
//#define OLED_WR_Clr() GPIO_ResetBits(GPIOA,GPIO_Pin_1)
//#define OLED_WR_Set() GPIO_SetBits(GPIOA,GPIO_Pin_1)

//#define OLED_RD_Clr() GPIO_ResetBits(GPIOA,GPIO_Pin_2)
//#define OLED_RD_Set() GPIO_SetBits(GPIOA,GPIO_Pin_2)
